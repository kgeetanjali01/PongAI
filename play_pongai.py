...
class PongGame:
    ...
    # Testing the AI against a human player by passing a NEAT neural network
    ...
    # Training the AI by passing two NEAT neural networks and the NEAt config object.
    ...
    # Determining where to move the left and the right paddle based on the two 
